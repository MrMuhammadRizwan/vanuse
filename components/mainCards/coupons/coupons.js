            ...
            <div className="p-60 ">
                ...
                <div className="mb-31 custom-title">
                    <TextField 
                        ...
                        variant="outlined"label="Promo Code"placeholder="Promo Code"error={promoError}helperText={promoValidFromApi?"Promo code not valid":null}
                        value={promoValue} onChange={(e)=>setPromoValue(e.target.value)}
                    />
                </div>
