  ...
  return (
    <>
      ...
      <div className="mb-50 van-wrap">
        <div
          className={sVan ? "van-box van-box-active" : "van-box"}
          onClick={() => setActiveVan("s-van")}
        >
          <svg
            width="72"
            height="31"
        ...
        <div
          className={mVan ? "van-box van-box-active" : "van-box"}
          onClick={() => setActiveVan("m-van")}
        >
          <svg
            width="75"
            height="36"
        ...
        <div
          className={lVan ? "van-box van-box-active" : "van-box"}
          onClick={() => setActiveVan("l-van")}
        >
          <svg
            width="78"
            height="40"
        ...
        <div
          className={xVan ? "van-box van-box-active" : "van-box"}
          onClick={() => setActiveVan("x-van")}
        >
          <svg
            width="84"
            height="50"
