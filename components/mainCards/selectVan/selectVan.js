...
const SelectVan = (props) => {
  ...
  const addPaymentNow = () => {
    ...
    Axios({
      ...
      url: `${process.env.API_URL}/cart-item/add_items_in_cart/`,
      data: tripNow,
    })
      .then(function (response) {
  ...
  const setActiveVan = (value) => {
    ...
    switch (value) {
    case "s-van":
      return setSVan(true), setMVan(false), setLVan(false), setXVan(false), setPrice(21);
    case "m-van":
      return setSVan(false), setMVan(true), setLVan(false), setXVan(false), setPrice(25);
    case "l-van":
      return setSVan(false), setMVan(false), setLVan(true), setXVan(false), setPrice(70);
    case "x-van":
      return setSVan(false), setMVan(false), setLVan(false), setXVan(true), setPrice(100);
    }
  };
  ...
  return (
    <>
      ...
      <div className="mb-50 van-wrap">
        <div className={sVan ? "van-box van-box-active" : "van-box"} onClick={() => setActiveVan("s-van")}>
        ...
        <div className={lVan ? "van-box van-box-active" : "van-box"} onClick={() => setActiveVan("l-van")}>
        ...
        <div className={xVan ? "van-box van-box-active" : "van-box"} onClick={() => setActiveVan("x-van")}>
      ...
      <div className={"help-slection card-slection mb-31"}>
        <Checkbox checked={iNeedHelp} onChange={iNeedHelpFunc} inputProps={{ "aria-label": "controlled" }} />
        <p>
      ...
      <div className="card-buttons-grid">
        <Button key={"Back"} className="lightbutton" onClick={props.fillVan ? props.goBackThirdScreen : props.goBack}>
          Back
        </Button>
        <Button
          key={"Next"}
