  ...
  return (
    <>
      ...
      <div className="mb-50 van-wrap">
        <div className={van ==='small' ? "van-box van-box-active" : "van-box"} onClick={() => setVan("small")}>
        ...
        <div className={van ==='medium' ? "van-box van-box-active" : "van-box"} onClick={() => setVan("medium")}>
        ...
        <div className={van ==='large' ? "van-box van-box-active" : "van-box"} onClick={() => setVan("large")}>
        ...
        <div className={van ==='extra large' ? "van-box van-box-active" : "van-box"} onClick={() => setVan("extra large")}>
